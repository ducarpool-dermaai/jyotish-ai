...
body{background:var(--bg);color:var(--text);font-family:var(--fb);font-size:17px}
.app{min-height:100vh}
.wrap{max-width:900px;margin:0 auto;padding:0 16px 60px}

/* HEADER */
.hdr{text-align:center;padding:28px 0 18px}
.hom{font-size:36px;color:var(--gold2);display:block;margin-bottom:5px;
  animation:glow 4s ease infinite}
@keyframes glow{0%,100%{text-shadow:0 0 12px rgba(201,146,28,.3)}
  50%{text-shadow:0 0 28px rgba(201,146,28,.6)}}
.htitle{font-family:var(--fh);font-size:clamp(22px,4vw,40px);font-weight:500;
  letter-spacing:.15em;color:var(--gold)}
.hsub{font-size:14px;color:var(--muted);font-style:italic;margin-top:4px;letter-spacing:.13em}
...
.ti{
  ...
  font-family:var(--fh);font-size:11px;letter-spacing:.06em;
...
.snv{font-family:var(--fh);font-size:12px;letter-spacing:.06em;color:var(--amber);
  margin-bottom:2px;line-height:1.3;word-break:break-word}
.snk{font-size:11px;color:var(--muted)}
...
.emp-t{font-family:var(--fh);font-size:12px;letter-spacing:.2em;color:var(--gold);
  text-transform:uppercase;margin-bottom:8px}
.emp-s{font-style:italic;font-size:16px;line-height:1.85}
...
.lbl{font-family:var(--fh);font-size:10.5px;letter-spacing:.2em;color:var(--gold);
  text-transform:uppercase}
.fi{background:var(--bg);border:1px solid var(--border);border-radius:6px;
  color:var(--text);font-family:var(--fb);font-size:16px;padding:9px 11px;
...
.fh{font-size:12px;color:var(--muted);font-style:italic;margin-top:2px}
...
/* SECTION TITLE */
.stitle{font-family:var(--fh);font-size:11px;letter-spacing:.25em;color:var(--amber);
  text-transform:uppercase;padding-bottom:10px;margin-bottom:13px;
  border-bottom:1px solid var(--border)}

/* PLANET TABLE */
.pt{width:100%;border-collapse:collapse;font-size:12.5px}
.pt th{font-family:var(--fh);font-size:9px;letter-spacing:.17em;color:var(--amber);
  text-transform:uppercase;padding:6px 7px;border-bottom:1.5px solid var(--border);text-align:left}
.pt td{padding:7px 9px;border-bottom:1px solid var(--b2);vertical-align:middle}
.pt tr:last-child td{border-bottom:none}
.pt tr:hover td{background:rgba(160,100,10,.025)}
.pn{font-family:var(--fh);font-size:11px;letter-spacing:.07em;color:var(--deep)}
.ps2{color:var(--amber);font-size:14px}
.pd{color:var(--muted);font-size:12.5px;font-family:monospace}
...
.dlbl{font-family:var(--fh);font-size:9.5px;letter-spacing:.22em;color:var(--gold);margin-bottom:4px}
.dmain{font-family:var(--fh);font-size:20px;color:var(--deep)}
.dsub{font-size:14px;color:var(--muted);margin-top:2px}
.dseq{display:flex;gap:5px;flex-wrap:wrap}
.dchip{padding:5px 11px;border-radius:14px;font-family:var(--fh);font-size:9px;
...
.pl{font-family:var(--fh);font-size:9px;letter-spacing:.2em;color:var(--gold);
  text-transform:uppercase;margin-bottom:4px}
.pv{font-family:var(--fh);font-size:14px;color:var(--deep);margin-bottom:2px;line-height:1.3}
.psb{font-size:12px;color:var(--muted)}
...
.cn{font-family:var(--fh);font-size:11.5px;letter-spacing:.07em;color:var(--deep);margin-bottom:2px}
.ct{font-size:12.5px;color:var(--muted);font-family:monospace}
.ctg{font-family:var(--fh);font-size:8.5px;letter-spacing:.1em;text-transform:uppercase;
...
.dt{font-family:var(--fh);font-size:13px;letter-spacing:.07em;color:var(--deep)}
.ds2{font-size:12px;color:var(--muted);font-style:italic;margin-top:1px}
...
.dstat{font-family:var(--fh);font-size:12px;letter-spacing:.12em;
  text-transform:uppercase;margin-bottom:5px}
.dc.yes .dstat{color:var(--red)}.dc.no .dstat{color:var(--green)}.dc.maybe .dstat{color:#8a6a00}
.ddesc{font-size:15px;line-height:1.75;color:var(--text)}
...
.drl{font-family:var(--fh);font-size:9px;letter-spacing:.1em;color:var(--muted);
...
.trs{color:var(--amber);font-size:14px;flex:1}
...
.cmb{padding:10px 14px;border-radius:11px;font-size:15px;line-height:1.75}
...
.cinp{flex:1;background:var(--bg);border:1px solid var(--border);border-radius:8px;
  color:var(--text);font-family:var(--fb);font-size:15px;padding:9px 12px;
...
.snum{font-family:var(--fh);font-size:28px;line-height:1}
...
.kn{font-family:var(--fh);font-size:9px;letter-spacing:.12em;color:var(--muted);
  text-transform:uppercase;margin-bottom:2px}
.ks{font-family:var(--fh);font-size:13.5px;color:var(--deep)}
...
.mvt{font-family:var(--fh);font-size:13.5px;letter-spacing:.13em;text-transform:uppercase;margin-bottom:5px}
.mvd{font-size:15px;line-height:1.75;color:var(--text)}

/* READING */
.reading h3{font-family:var(--fh);color:var(--amber);font-size:11px;letter-spacing:.2em;
...
.reading li{font-size:15.5px;line-height:1.8;padding-left:13px;position:relative;margin-bottom:2px}
